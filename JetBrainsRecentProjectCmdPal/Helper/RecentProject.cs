...
{
    [XmlElement("component")] public RecentProjectsManager Component { get; set; } = new();
}
...
public class RecentProjectsManager
{
    ...
    [XmlElement("option")] public List<RecentProjectsOption> Options { get; set; } = new();
}
...
public class RecentProjectsOption
{
    ...
    [XmlElement("list")] public RecentProjectsList List { get; set; } = new();

    [XmlElement("map")] public RecentProjectsMap Map { get; set; } = new();
}
...
{
    [XmlElement("option")] public List<RecentProjectsListOption> Options { get; set; } = new();
}
...
{
    [XmlElement("entry")] public List<RecentProjectsEntry> Entries { get; set; } = new();
}
...
public class RecentProjectsEntry
{
    ...
    [XmlElement("value")] public RecentProjectsEntryValue Value { get; set; } = new();
}
...
{
    [XmlElement("RecentProjectMetaInfo")] public RecentProjectMetaInfo RecentProjectMetaInfo { get; set; } = new();
}
...
{
    [XmlElement("option")] public List<RecentProjectMetaInfoOption> Options { get; set; } = new();
}
